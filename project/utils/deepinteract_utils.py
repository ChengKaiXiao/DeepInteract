...
def collect_args():
    ...
    parser.add_argument('--experiment_name', type=str, default='Model_864_0', help='Logger experiment name')
    ...
    parser.add_argument('--num_workers', type=int, default=60, help='Number of CPU threads for loading data')
